...
export function HeroSection() {
  return (
    <section className="relative overflow-x-clip bg-lp-hero-dark">
      {/* Background gradient — mesh-style layered radials, extends below hero for seamless spill */}
      <div className="absolute top-0 right-0 left-0 -bottom-32 sm:-bottom-40 md:-bottom-52">
        {/* Base: near-black */}
        <div className="absolute inset-0 bg-[#020005]" />
        {/* Core purple nebula — center-left */}
        <div
          className="absolute inset-0"
          style={{
            background:
              'radial-gradient(ellipse 70% 65% at 38% 45%, #5B28D0 0%, #3A108A 35%, transparent 70%)',
          }}
        />
        {/* Bright purple hotspot */}
        <div
          className="absolute inset-0"
          style={{
            background:
              'radial-gradient(ellipse 50% 45% at 42% 50%, rgba(155, 80, 248, 0.6) 0%, transparent 60%)',
          }}
        />
        {/* Upper-right dark pull */}
        <div
          className="absolute inset-0"
          style={{
            background:
              'radial-gradient(ellipse 60% 50% at 75% 20%, #020005 0%, transparent 70%)',
          }}
        />
        {/* Bottom-right lavender wash */}
        <div
          className="absolute inset-0"
          style={{
            background:
              'radial-gradient(ellipse 65% 55% at 80% 85%, #E0D0F8 0%, #9868E8 30%, transparent 65%)',
          }}
        />
        {/* Bottom fade — soft spill into problem section */}
        <div
          className="absolute inset-0"
          style={{
            background:
              'linear-gradient(to bottom, transparent 50%, rgba(255,255,255,0.06) 60%, rgba(255,255,255,0.2) 70%, rgba(255,255,255,0.45) 80%, rgba(250,250,250,0.75) 90%, #FAFAFA 100%)',
          }}
        />
        {/* Left-edge darkness */}
        <div
          ...
          style={{
            background:
              'radial-gradient(ellipse 40% 70% at 0% 50%, #010003 0%, transparent 60%)',
          }}
        />
        {/* Top darkness */}
        <div
          ...
          style={{
            background:
              'radial-gradient(ellipse 80% 30% at 50% 0%, #010003 0%, transparent 50%)',
          }}
        />
      ...
      {/* Bottom spacer — overlap with problem section handles the transition */}
